...
export class UploadService {
    ...
    handleImageUpload(req: Request) {
        return new Promise<{ original: string; thumbnail: string }>(async (resolve, reject) => {
            ...
            form.on('end', async () => {
                ...
                await fs.copy(uploadedPath, path.join(staticPath, originalName));
                ...
                const opResult = await this.uploadCollection.insertOne(uploadRecord);
